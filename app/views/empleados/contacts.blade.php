...
@section('header')
	...
	<h2 class="subtitol1">Contactos de {{ $empleado->nombre.' '.$empleado->apellido1.' '.$empleado->apellido2 }}</h2>

@stop

@section('content')

	<a class="btn btn-primary boto1" href="{{ route('empleados.show', $empleado->id) }}">Finalizar edicion</a>
	...
	<div class="row">
		...
		<div class="col-xs-4">
			...
			<p><h3>Telefonos del empleado: </h3></p>
