...
@section('header')
	...
	<h2 class="subtitol1">Contactos de {{ $cliente->nombre.' '.$cliente->apellido1.' '.$cliente->apellido2 }}</h2>

@stop

@section('content')
	
	<a class="btn btn-primary boto1" href="{{ route('clientes.show', $cliente->id) }}">Finalizar edicion</a>
	...
	<div class="row">
		...
		<div class="col-xs-4">
			...
			<p><h3>Telefonos del cliente: </h3></p>
